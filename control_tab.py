...
# we are using GPIO for dropping stuff and turning on LEDs
...
class ControlTab:
    def __init__(self, drone):
        ...
        # we are operating servo from arduino but would be better to operate from arduino
        ...
        # can use channel overrides if prefferred but wont be as stable
        self.speed_x = 0
        self.speed_y = 0
        self.speed_z = 0
    ...
    def armAndTakeoff(self, takeoff_alt):
        ...
        # setting to guided because we will control from keyboard
        # and set pixahawk to guided mode
    ...
    def togleLights(self):
        ...
        # simple algorythim if its on trurn off vice versa
    ...
    def activateMission(self, points_data):
        # if it was in auto set to GUIDED and freeze drone
        # add commands, then set to auto
        # if no commands in memory wont do anything
        ...
        # if none of the above 2 catch then this is a new mission and we need to add commands
        self.vehicle.commands.next = 0
        cmds = self.vehicle.commands
        cmds.clear()
        ...
        # we are iterating through protobuf mission and will add individual commands
        # MAVLINK waypoints
